        ...
        .apply {
            if (state != null) {
                addFunction(
                    FunSpec.builder(
                        "saveState",
                    ).addModifiers(KModifier.OVERRIDE).returns(state).addCode(TODO_GENERATED_BUT_NOT_IMPLEMENTED).build(),
                )
                addFunction(
                    FunSpec.builder(
                        "restoreState",
                        ...
                        "state",
                        state,
                    ).addModifiers(KModifier.OVERRIDE).addCode(TODO_GENERATED_BUT_NOT_IMPLEMENTED).build(),
                )
            }
