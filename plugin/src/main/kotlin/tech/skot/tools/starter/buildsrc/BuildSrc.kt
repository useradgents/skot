                ...
                .addProperty(
                    propertySpec =
                        PropertySpec.builder(
                            ...
                            String::class,
                            KModifier.CONST,
                        ).initializer("\"${configuration.appName}\"").build(),
                )
                .addProperty(
                    propertySpec = PropertySpec.builder("versionCode", Int::class, KModifier.CONST).initializer("1").build(),
                )
                .addProperty(
                    propertySpec =
                        PropertySpec.builder(
                ...
                .addProperty(
                    propertySpec =
                        PropertySpec.builder(
                            ...
                            String::class,
                            KModifier.CONST,
                        ).initializer("\"${Versions.skot}\"").build(),
                )
                .build(),
        ).build().writeTo(rootDir.resolve("buildSrc/src/main/kotlin"))
