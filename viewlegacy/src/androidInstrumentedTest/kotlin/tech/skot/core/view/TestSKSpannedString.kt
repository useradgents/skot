...
class TestSKSpannedString : SKTestView() {
    ...
    fun testViewPart() {
        val skSpan =
            SKSpannedStringViewProxy(
                spans(underline = false, striked = false),
            )

        val skSpanUnderline =
            SKSpannedStringViewProxy(
                spans(underline = true, striked = false),
            )

        val skSpanStriked =
            SKSpannedStringViewProxy(
                spans(underline = false, striked = true),
            )

        val skSpanBoth =
            SKSpannedStringViewProxy(
                spans(underline = true, striked = true),
            )
